...
export default function PanelTwo() {
  ...
  const data = useStaticQuery(graphql`
    query {
      ...
      inclusion: file(relativePath: { eq: "inclusion.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 600, quality: 50) {
            ...GatsbyImageSharpFluid_withWebp
          }
      ...
      learningsupports: file(relativePath: { eq: "learningsupports.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 600, quality: 50) {
            ...GatsbyImageSharpFluid_withWebp
          }
      ...
      lgbtq: file(relativePath: { eq: "lgbtq.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 600, quality: 50) {
            ...GatsbyImageSharpFluid_withWebp
          }
      ...
      mentalhealth: file(relativePath: { eq: "mentalhealth.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 600, quality: 50) {
            ...GatsbyImageSharpFluid_withWebp
          }
  ...
  return (
    <div className={classes.root}>
      <div className={classes.grid}>
        <div>
          <Card
            image={data.mentalhealth.childImageSharp.fluid}
          ...
          <Card
            image={data.inclusion.childImageSharp.fluid}
          ...
          <div className={classes.rowGap} />
          <Card
            image={data.lgbtq.childImageSharp.fluid}
        ...
        <div className={classes.shift}>
          <Card
            image={data.school.childImageSharp.fluid}
          ...
          <div className={classes.rowGap} />
          <Card
            image={data.learningsupports.childImageSharp.fluid}
          ...
          <div className={classes.rowGap} />
          <Card
            image={data.collaboration.childImageSharp.fluid}
            title={"COLLABORATION"}
            paragraph={
